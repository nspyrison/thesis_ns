...
The algorithm is primarily operating on the projection basis and utilizes the data only when making a display for computational efficiency. A broader list of touring notation is given in \ref{sec:tour_notation}.
