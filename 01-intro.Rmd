...
\begin{itemize}
\item[A] **Can user controlled steering (UCS) be utlized in an environment providing only animation?**
\item[B] **How do we etend UCS to 3D?**
\item[C] **What benefits does UCS provide over current common practice, such as PCA, MDS, tSNE? **
\item[D] **Does UCS with 3D displays provide perception benefits over 2D displays?**
\end{itemize}
