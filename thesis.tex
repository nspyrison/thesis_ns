...
\section{Spinifex}\label{spinifex}

\begin{itemize}
\tightlist
\item
  Supply an orthonormal basis, \textbf{B}\_\{{[}p x d{]}\}.
  \textbackslash{} Let \emph{d = 2} for illustration.
\item
...
\tightlist
\item
  Select \emph{\theta*, angle of rotation with-in the plane of the XY
  projection, and a vector of }\phi\_i\emph{, the angle of out-of plane
  rotation, orthagonal to the projection plane (relative to
  }\phi\_1\emph{, the transformation }\phi\_i* - *\phi\_1* proved to be
  helpful to discuss *\phi* relative to the Z axis.)
\end{itemize}
