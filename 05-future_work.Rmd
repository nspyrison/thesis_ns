...
This is an **algorithm design**, first, the *R* package spinifex will be extended to 3D, and surface & function projections will be implemented. After the projections are performed *Unity* will be used to render the embeddings in 3D VR and offer a compatible front end to be used across display devices.
