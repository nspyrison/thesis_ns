...
1. **How do we implement UCS in 1- and 2D projections?** (Completed work, chapter \ref{ch:completed_work}) User-controlled steering of dynamic projections allows for the user to select which and how a specific variable should be rotated. This is completed work following the research of @cook_manual_1997. I have implemented UCS in 1- and 2D and built an extensible platform for projection into $d>2$ spaces.
...
3. **How do we extend UCS to 3D?** (Future work, chapter \ref{ch:future_work}) This *experimental design* will be novel work in extending dynamic projections, including UCS, to 3D. The work done in RO 1 will be used in conjunction with @cordeil_immersive_2019 to form an UI compatible across display devices.
