...
#' @examples
#' nsSafeIncGraphic("./figures_from_script/ch2_fig1_penguin_splom.pdf")
nsSafeIncGraphic <- function(fp = "./dummy/figure/filepath.pdf"){
...
This book covers is the PhD thesis during my studies at Monash University, Australia.

A pdf version can be found [here](https://github.com/nspyrison/thesis_ns/blob/master/docs/thesis_ns.pdf) and its code repository can be found on [github](https://github.com/nspyrison/thesis_ns).
