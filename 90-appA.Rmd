...
* Basis axes/refernece axes, a display showing how each variables coeffiecient(s) contribute to a porjection. Either on its own axis (1D) or relative to a unit circle (2D).
