...
glossary_df <- data.frame(
  ...
  Alias = c(
    ...
    "independent-/input- variable, predictors, covariates", 
...
thesis_df <- tibble::tribble(
  ~Content,                                           ~Link,
  "thesis repository",                                "https://shorturl.at/clqvB",
  "thesis, pdf format",                               "https://shorturl.at/uBYZ5",
  "thesis, html format",                              "https://shorturl.at/dftCN",
...
ch5_df <- tibble::tribble(
  ~Content,                                                                    ~Link,
  "cheem vignette, Getting started with cheem",                                "https://shorturl.at/kqsF0",
  "cheem documentation website",                                               "https://nspyrison.github.io/cheem/",
  "Penguins cheem radial tour, Figure \\@ref(fig:casepenguins)",               "https://vimeo.com/666431172",
  "Chocolates, cheem radial tour, Figure \\@ref(fig:casechocolates)",          "https://vimeo.com/666431143",
  "Chocolates2, cheem radial tour, Figure \\@ref(fig:casechocolatesinverse)",  "https://vimeo.com/666431148",
  "FIFA 2020, cheem radial tour, Figure \\@ref(fig:casefifa)",                 "https://vimeo.com/666431163",
  "North Ames housing prices, cheem radial tour, Figure \\@ref(fig:caseames)", "https://vimeo.com/666431134",
)
...
if(knitr::is_html_output()){
  ...
  fmt <- "latex"
  fnt <- 10L
  esc <- FALSE ## latex needs \ escaping on urls to use false.
...
This thesis was written with statistics terminology. This glossary helps bridge the language used here to be more accessible to machine learning audiences.
...
Below collects links of animations related to the content as well as vignettes and related documentation. The content for chapter 4 continues with a bit of an extended analysis looking at the visual displays in the user study, the participant demographics, and a parallel analysis regressing of log time.
...
This section covers extended analysis. First, an illustrations of the different visuals are provided. Then, the demographics of the participants is covered. Lastly, a parallel modeling analysis on log response time is conducted.


### Illustrations of visual methods

Below illustrates the three visual methods evaluated in the user study. Data was collected from a __shiny__ application, and used pre-rendered `gif` files based on the selected inputs.

```{r out.width="100%", fig.cap = "Examples of application for PCA, grand tour, and radial tour."}
