...
This work is concerned with linear projections of multivariate data. More specifically, we focus on the class of visualizations known as _tours_ [@cook_grand_2008; @lee_state_2021]. Tours are viewed near-continuously through small changes to the projection basis. There are many variants of tours. We focus on one of the variants, _radial tours_ [@cook_manual_1997; @spyrison_spinifex_2020]. Radial tours can be used to control or steer the projection basis, while other tour variants select bases randomly or optimize an objective function. Because of this unique attribute, _user interaction_ is another key aspect of interest in this work.
...
nsSafeIncGraphic("./figures/ch5_fig1_shap_distr_bd.pdf")
```
...
nsSafeIncGraphic("./figures/ch5_fig2_global_space.pdf")
```
...
nsSafeIncGraphic("./figures/ch5_fig3_cheem_initial_bas.pdf")
```
...
nsSafeIncGraphic("./figures/ch5_fig4_cheem_endpts.pdf")
```
