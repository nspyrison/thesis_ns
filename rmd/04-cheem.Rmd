...
nsSafeIncGraphic("./figures_from_script/ch5_fig1_shap_distr_bd.pdf")
```
...
nsSafeIncGraphic("./figures_from_script/ch5_fig2_global_space.pdf")
```
...
nsSafeIncGraphic("./figures_from_script/ch5_fig3_cheem_initial_bas.pdf")
```
...
nsSafeIncGraphic("./figures_from_script/ch5_fig4_cheem_endpts.pdf")
```
