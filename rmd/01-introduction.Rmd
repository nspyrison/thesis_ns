...
nsSafeIncGraphic("./figures/data_analysis_workflow.png")
```
...
nsSafeIncGraphic("./figures/matejka17fig.png")
```
...
fp <- "./figures_from_script/ch2_fig1_penguin_splom.pdf"
...
nsSafeIncGraphic("./figures_from_script/ch2_fig2_penguin_pcp.pdf")
```
...
nsSafeIncGraphic("./figures/buja05fig.png")
```
