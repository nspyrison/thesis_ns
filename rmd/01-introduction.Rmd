...
@cook_manual_1997 laid out the theoretical work for the manual (and hence radial) tour, some details are light. Furthermore, there is an absence of a publicly available implementation, fully-featured interface design, implementation notes, and evaluation of performance over alternatives.
