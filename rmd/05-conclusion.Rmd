...
<!-- cheem -->
Similarly, __cheem__ analysis could be generalized to broader range of models and local explanations.  The models and local explanations facilitated by `DALEX::explain()` seems to be a good direction to extend [@biecek_dalex_2018; @biecek_explanatory_2021]. Alternatively, other statistics may better show the structure identified by explanations that could be added.
