...
## Extended analysis {#sec:extanalysis}

<!-- segue to extended analysis -->
This section covers extended analysis. First, the demographics of the participants is covered. Then a parallel modeling analysis on log response time is conducted. Lastly, the effect ranges and marginal effects of the random effect of the participants and data simulation are examined.
