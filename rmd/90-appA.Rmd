...
glossary_df <- data.frame(
  Term = c("observation", "variable", "data", "basis", "projection", "tour",
           "Intrinsic data dimensionality", "Non-linear model"),
  Notation = c(
...
supp_mats_df <- data.frame(
  Context = c("spinifex", "spinifex", "spinifex", "cheem", 
              "cheem", "thesis", "thesis", "thesis"),
  Description = c(
    "CRAN Link", "vignette, Getting started with spinifex", 
    "vignette, Ggproto api", "CRAN Link", "vignette, Getting started with cheem", 
