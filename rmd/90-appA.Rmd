...
\begin{table}[!ht]
    ...
    \hline
        Term  & Notation & Alias & Meaning \\ \hline
        observation & n & instance, item, row (of data) & A unit being measured across the variables. \\ \hline
        variable & p & feature, column (of data) & A measure taken across all observations. \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{|l|l|l|l|}
    \hline
        Context & Type & Content & Link \\ \hline
        spinifex  & vignette & Getting started with spinifex & https://nspyrison.github.io/spinifex/articles/getting-started-with-spinifex.html \\ \hline
        spinifex  & vignette & Ggproto API & https://nspyrison.github.io/spinifex/articles/ggproto-api.html \\ \hline
        cheem & vignette & Getting started with cheem & https://nspyrison.github.io/cheem/articles/getting-started-with-cheem.html \\ \hline
        thesis & html version & html version & https://nspyrison.github.io/thesis\_ns/ \\ \hline
        thesis  & repository & Reproducibility and source code & https://github.com/nspyrison/thesis\_ns/blob/master/docs/thesis\_ns.pdf \\ \hline
    \end{tabular}
\end{table}
