...
>>> Will want to add radial tour

(ref:ch2fig5-cap) Radial tour of the penguins data across three geometric displays. The contribution of `bl` is being removed from the frame and with it the separation between the orange and green groups are also removed. Changing to density contours or hexagonal heatmap display are common ways to mitigate occlusion caused by dense observations. 
