...
```{r ch2fig2, echo=F, out.width='70%', fig.cap = "(ref:ch2fig2-cap)"}
...
In Chapter \@ref(ch-cheem), we turn our attention to predictive modeling, the loss of variable-level interpretablility of the non-linear models, and an attempt to maintain model transparence with local explanation.
