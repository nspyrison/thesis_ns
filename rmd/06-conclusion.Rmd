...
The __spinifex__ package is built around one and two-dimensional manual tours. The layered composition of tours is interoperable with $d \in [1, 2]$ tours produced with __tourr__. However, non-manual tours can easily increase the embedded dimensionality. As such, $d>2$ tours are under-supported in the layered composition.

<!-- Manual tours -->
In contrast, extending the projection space of the manual tour to 3D would require an additional manipulation angle. This would be rotated in a 4D manipulation space.

## Future work

>>>> Break apart into two sections: limitations and future work
>> scope: mostly scatterplot display, modest dimensionality
...
>> + Pedagogical side of manual tours for newcomers.
...
>> Extending explanations and a user study
...
<!-- XXX TODO: keep doing astrogrep paper, convert to chapter or equiv -->
<!-- XXX TODO: Does Cheem chapter still use intance/feature over observation/variable? -->
