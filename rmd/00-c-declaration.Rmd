...
- _"Is IEEE VIS that good?" On key factors in the initial assessment of manuscript and venue quality_ [@spyrison_is_2021]. This alt.VIS workshop paper covers a survey of IEEE VIS authors, how they source articles, decide which to read, and evaluate venue quality. We found low evidence that sentiment changes across academic positions for these topics and provided a discussion on the effects of the "publish or perish" environment, standard author and journal metrics, and difficulty in publishing "null" findings and replication studies.
