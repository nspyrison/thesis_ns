...
The work corresponding to Chapter \@ref(ch-spinifex) has been accepted for publication in _The R Journal_ [@spyrison_spinifex_2020]. The respective user study discussed in Chapters \@ref(ch-userstudy) has not yet been submitted. The contents of Chapter \@ref(ch-cheem) have been submitted to the _Journal of Machine Learning Research_ in May 2022.
...
- _Animated Linear Projections_, Invited to write an article for INFORMS magazine, OR/MS Tomorrow. to be printed next issue, 2022 Q1&2.
