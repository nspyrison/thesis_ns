...
Three paper are included in this thesis, one of which has been accepted for publication in _The R Journal_ [@spyrison_spinifex_2020]. The user study described in Chapter \ref{ch-efficacy_radial_tour} will shortly be submitted to the _Journal of Data Science, Statistics, and Visualisation_. The research covered in Chapter \ref{ch-cheem} will shortly be submitted to _The Journal of Machine Learning research_.
