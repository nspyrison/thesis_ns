...
nsSafeIncGraphic("./figures_from_script/ch4_fig1_pca_splom.pdf")
```
...
nsSafeIncGraphic("./figures_from_script/ch4_fig2_exp_factors.pdf")
```
...
nsSafeIncGraphic("./figures_from_script/ch4_fig3_accuracy_measure.pdf")
```
...
nsSafeIncGraphic("./figures_from_script/ch4_fig4_randomization_MANUAL.png")
```
...
nsSafeIncGraphic("./figures_from_script/ch4_fig5_ABcd_violins.pdf")
```
...
nsSafeIncGraphic("./figures_from_script/ch4_fig6_subjective_measures.pdf")
```
