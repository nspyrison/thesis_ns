...
mod_comp <- readRDS("./figures/ch4_tab1_model_comp_ls.rds") ## accuracy [[1]], log time [[2]]
...
mod_coef <- readRDS("./figures/ch4_tab2_model_coef_ls.rds") ## accuracy [[1]], log time [[2]]
output <- kableExtra::kbl(
