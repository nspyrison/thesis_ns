...
### Notation
#TODO: Notation needs work!
This section describes the notation used in the algorithm for a 2D radial manual tour.

- \textbf{X}, the data, an $n \times p$ numeric matrix to be embedded in two dimensions.
- \textbf{B}, any of orthonormal projection basis set, $p \time d$ matrix, describing the projection from $p$ to two dimensions
- e
- +
- +
