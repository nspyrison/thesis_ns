...
This section describes the notation used in the algorithm description. The data is an $n \times p$ numeric matrix to be embedded into $d, (d \leq p),$ dimensions.
