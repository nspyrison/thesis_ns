...
<!-- \begin{align*} -->
<!--   \textbf{M}_{[p,~3]} -->
<!--   &= Orthonormalize_{GS}(\textbf{B}_1,\textbf{B}_2,\textbf{e}) \\ -->
<!--   &= (\textbf{B}_1, \textbf{B}_2, \textbf{e} - \langle \textbf{e},\textbf{B}_1 \rangle \textbf{B}_1 - \langle \textbf{e}, \textbf{B}_2 \rangle \textbf{B}_2 \\ -->
<!--   \left( -->
<!--     \begin{bmatrix} -->
<!--       B_{1,~1} & \dots  & B_{1,~d} \\ -->
<!--       B_{2,~1} & \dots  & B_{2,~d} \\ -->
