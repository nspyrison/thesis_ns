...
\section{Applcation}\label{applcation}
...
The code used to generate this chapter can be found on {[}GitHub{]}
(\url{https://github.com/nspyrison/Confirmation/blob/master/03-spinifex.Rmd}).
