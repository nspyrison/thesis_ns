...
\item
  ...
  \item
    Scatterplot matrix \autocite{emerson_generalized_2013}, showing a
    triangle matrix of bivariate scatterplots with 1-d density on the
    diagonal.
  \item
    Radial glyphs \autocite{Glyphs}, radial variants of parallel
    coordinates including radar, spider, and star glyphs.
  \end{itemize}
\end{itemize}
