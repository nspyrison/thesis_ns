...
Currently there is no compiling software that offers UCS (RO \#1) I have
extended the graphic options for touring dynamic projections and
reimplemented UCS on a compatible platform for more sustainable support
(RO \#1). A comparative study outlining the benefits of UCS vs
alternatives is also absent from the literature (RO \#2).
...
\addcontentsline{toc}{chapter}{PhD schedule}
...
{\centering \includegraphics[width=0.98\linewidth]{thesis_files/figure-latex/step0-paper-1} 
...
{\centering \includegraphics[width=1\linewidth]{thesis_files/figure-latex/step2-paper-1} 
...
{\centering \includegraphics[width=6in,height=7.2in]{thesis_files/figure-latex/step3-paper-1} 
