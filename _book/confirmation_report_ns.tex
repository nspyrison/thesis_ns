...
across treatment of display device (including 2D standard monitor, 3D
head-tracked monitor, and head-mounted display). Quantitative
...
scatterplot projection. Basis and projection axes should marked from
origin.}\label{fig:RO3MockUp}
\end{figure}
...
structure, surface structure, and ranking of manipulation variable. All
