...
\KeywordTok{view_basis}\NormalTok{(f_bas, }\DataTypeTok{data =}\NormalTok{ f_dat, }\DataTypeTok{labels =}\NormalTok{ f_lab)}
\CommentTok{# View the manip space}
\KeywordTok{view_manip_space}\NormalTok{(}\DataTypeTok{basis =}\NormalTok{ f_bas, }\DataTypeTok{manip_var =}\NormalTok{ f_mvar, }\DataTypeTok{labels =}\NormalTok{ f_lab)}
\CommentTok{# Play animation as HTML5 from plotly}
