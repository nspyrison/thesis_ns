...
Terminology varies across author and implementation. In my work, I use the following
...
For the sake of brievity and relavence we stick to discussion of multivariate data vizualization in 3D, for wider scope see Chapter 2 of @marriott_immersive_2018.

### A rocky start

Scientific visualization have readily adopted mixed realities as a large amount of the science exist in 3 spatial dimensions, lending itself well to virtual immersion. Data vizualisation, on the other hand, has been been slow to utilize graphics above 2.5D, (and haptic interaction) primarily due to the hype of 3D visuals from the 1980's and 90's [@munzner_visualization_2014]. 
