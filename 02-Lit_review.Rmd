...
* 1D geoms
    + 1D densities: such as histogram, average shifted histograms[@scott85], and kernel density[@scott95].
    + image: [@Wegman 2001]
...
* ORCA [@sutherland_orca_2000] -- Extensible toolkit build off the object-oriented Java.
...
For the sake of brevity, we'll stick to discussion of multivariate data visualization in 3D, for wider scope see chapter 2 of @marriott_immersive_2018.
...
* Depth cues - an indication that tips off depth to an observer, including linear perspective, aerial perspective, occulation, motion perspective, accommodation, convergence, binocular disparity, and binocular stereopsis
