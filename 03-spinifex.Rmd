...
```{r, eval=F, include=F}
### netlify .rmd files 
file.edit("../nspyrison_netlify/content/thesis/PDFsense_ManualTour_fig7.rmd")
file.edit("../nspyrison_netlify/content/thesis/PDFsense_ManualTour_fig8.rmd")
```
...
```{r PDF8good, echo=F, fig.width = 6, fig.height = 2*(6/1.61), fig.cap = "Manual tour of the PC6. First 6 priciple compoents of select experiments with 'dimuon SIDIS' in green , ‘DIS HERA1+2’ experiments in black, and 'charm SIDIS' in red. Note that intermetiate values of PC6 contain almost all of the information held within the green, dimuon SIDIS eperements"}
...
# play_manual_tour(PDF8_dat, PDF8_bas, PDF8_mtour, angle = .28, axes="bottomleft", cat_var = PDF8_cat)

interpolate2static(.m_tour = PDF8_mtour, .data = PDF8_dat, .m_var = PDF8_m_var,
                   .angle = .28, .cat = PDF8_cat, .mag = 2.4)
##M_VAR, RESULT
# 1, green jet
# 2, *poor
# 3, black
...
https://nspyrison.netlify.com/thesis/pdfsense_manualtour_fig8var6/
The page take a bit to load as the .html object is large.

```{r PDF8bad, echo=F, fig.width = 6, fig.height = 2*(6/1.61), fig.cap = "FILL CAPTION HERE"}
# Fig 8, bad
PDF8_m_var <- 2
PDF8_mtour <- manual_tour(basis = PDF8_bas, manip_var = PDF8_m_var)
...
TODO: UPDATE 
Dynamic version of this manual tour can be found at:
https://nspyrison.netlify.com/thesis/pdfsense_manualtour_fig8var2/
The page take a bit to load as the .html object is large.
...
```{r PDF7good, echo=F, warning=F, fig.width = 6, fig.height = 2*(6/1.61), fig.cap = "FILL CAPTION HERE"}
...
interpolate2static(.m_tour = PDF7_mtour, .data = PDF7_dat, .m_var = PDF7_m_var,
...
TODO: UPDATE
Dynamic version of this manual tour can be found at:
https://nspyrison.netlify.com/thesis/pdfsense_manualtour_fig7var3/.
The page take a bit to load as the .html object is large.

```{r PDF7bad, echo=F, warning=F, fig.width = 6, fig.height = 2*(6/1.61), fig.cap = "FILL CAPTION HERE"}
# Fig 7, subset to ATLAS7old and ATLAS7new
...
TODO: UPDATE 
Dynamic version of this manual tour can be found at:
https://nspyrison.netlify.com/thesis/pdfsense_manualtour_fig7var4/
The page take a bit to load as the .html object is large.
...
This article was created using Rmarkdown (@xie_r_2018), with code to generate the examples inline, and the source files can be found at [github.com/nspyrison/confirmation/](https://github.com/nspyrison/confirmation/).

The source code for the `spinifex` package can be found at [github.com/nspyrison/spinifex/](https://github.com/nspyrison/spinifex/). To install the package in R :

```{r INSTALLCODE, eval=F, echo=T}
devtools::install_git("nspyrison/spinifex")
```
