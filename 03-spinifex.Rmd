...
```
```{r step0, fig.cap = "basis and projection, holes guided tour of flea data"}
...
```
```{r step2, fig.cap = "manipulation space, holes guided tour of flea data"}
knitr::include_graphics("./output/step2_manip_sp.png")
```
