...
This article was created using Rmarkdown (@xie_r_2018), with code to generate the examples inline, and the source files can be found at https://github.com/nspyrison/Confirmation/. 

The source code for the `spinifex` package can be found at XXX. To install the package in R :
