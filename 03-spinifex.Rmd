...
slides <- create_slides(tour = mtour, data = flea_std)
...
The development version is available for installation via:
...
The code used to generate this work can be found at this [GitHub.com/nspyrison/Confirmation](https://github.com/nspyrison/Confirmation/).
