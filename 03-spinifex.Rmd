...
```{r PDF7, results = 'hide', warning=F, fig.width = 6, fig.height = 2*(6/1.61), fig.cap = "FILL CAPTION HERE"}
...
https://nspyrison.netlify.com/thesis/pdfsense_manualtour_fig7/.
...
Manual tour on PC6:
```{r PDF8, results = 'hide', fig.width = 6, fig.height = 2*(6/1.61), fig.cap = "FILL CAPTION HERE"}
...
# play_manual_tour(PDF8_dat, PDF8_bas, PDF8_m_var, angle = .28, axes="bottomleft") 
...
TODO: UPDATE 
Dynamic version of this manual tour can be found at:
https://nspyrison.netlify.com/thesis/pdfsense_manualtour_fig8/
The page take a bit to load as the .html object is large.
