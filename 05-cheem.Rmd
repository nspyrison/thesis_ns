...
## Originally R project `cheem`, though most of the writing exists in
# `phd_milestones`:
```

# Application of the radial tour to model-agnostic local explanations
...
knitr::include_graphics(
  "figures_from_script/ch5_fig1_shap_ditr_bd.pdf")
```
