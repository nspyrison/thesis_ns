...
# RO #B) 2D UCS vs alternatives -- dynamic low dimensional ebbedings
...
Slides created in R, using rmarkdown an xaringan

Document and slides -- [github.com/nspyrison/confirmation](https://github.com/nspyrison/confirmation)
<br><br><br><br>
