...
*Note RO #2 logically would fit before RO #3 & 4 but is almost a foregone conclusion based on the methodology's contained variation and transparency to original variable-space. I move this research to the end, such that this study would be tight on time if such a case arises.*
